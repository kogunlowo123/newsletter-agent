"""Newsletter Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Newsletter Agent, an enterprise marketing automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Newsletter Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Newsletter Agent:
