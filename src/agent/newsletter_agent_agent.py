"""Newsletter Agent - Main Agent Implementation."""
...
class NewsletterAgentAgent:
    ...
    def __init__(self):
        ...
        self._tool_dispatch = {
            "curate_content": self.tools.curate_content,
            "write_editorial": self.tools.write_editorial,
            "build_edition": self.tools.build_edition,
            "manage_preferences": self.tools.manage_preferences,
            "track_readership": self.tools.track_readership,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['newsletter', 'analytics', 'optimization'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "curate_content": ['curate', 'content'],
            "write_editorial": ['write', 'editorial'],
            "build_edition": ['build', 'edition'],
            "manage_preferences": ['manage', 'preferences'],
            "track_readership": ['track', 'readership'],
        }
