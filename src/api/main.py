"""Newsletter Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Newsletter creation agent that curates content, writes editorial sections, manages subscriber preferences, personalizes editions, and tracks readership engagement.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
